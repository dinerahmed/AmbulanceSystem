...
public class history implements Initializable {
    ...
    void view_history() throws IOException {
        ...
        File infoFile2 = new File("D:/Java Soft/diner_history_user/" + use.getUser() + "/info.csv");
        if (infoFile2.exists()) {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        user.setCellValueFactory(new PropertyValueFactory<>("driver"));
